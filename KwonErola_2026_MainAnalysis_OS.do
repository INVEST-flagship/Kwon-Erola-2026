*=== Kwon and Erola. 2026. Sociological Science. 
*= Last updated on May 24, 2026
cd "Your directory"
use "ZA5400_v4-0-0.dta", clear //version 4 is used for this analysis
	* Note: The main survey data, the ISSP 2009 (International Social Survey Programme; ZA5400; Version 4.0.0), are publicly available via the GESIS website (https://www.gesis.org/en/issp/data-and-documentation/social-inequality/2009) 
...
tab  age agegrp, m //respondents aged 15-24 and nonresponse are treated as missing
fre agegrp
...
merge m:1 country using "KwonJani_2026_MacroData.dta"
browse
...
save  KwonJani_2026_CombinedData_cleaned, replace /// Save it for the appendix analysis
...
estout m11 m12 m13, cells(b(star fmt(3)) se(par fmt(3))) starl(* 0.05 ** 0.010 *** 0.001) nobaselevels nolabel stats(N aic, labels ("No. of Obs." "AIC") fmt(0 3))
...
estout  m21 m22 m23, cells(b(star fmt(3)) se(par fmt(3))) starl(* 0.05 ** 0.010 *** 0.001) nobaselevels nolabel stats(N aic, labels ("No. of Obs." "AIC") fmt(0 3))
...
estout m31 m32 m33, cells(b(star fmt(3)) se(par fmt(3))) starl(* 0.05 ** 0.010 *** 0.001) nobaselevels nolabel stats(N aic, labels ("No. of Obs." "AIC") fmt(0 3))
